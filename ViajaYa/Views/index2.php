...
$sql= "SELECT user, name FROM Usuarios WHERE user= '$id_user'";
$sql1= "SELECT user,mail FROM Usuarios WHERE user= '$id_user'";
$sql3= "SELECT user FROM Usuarios WHERE user= '$id_user'";

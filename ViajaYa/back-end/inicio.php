...
                     <label for="idayvuelta">Ida y Vuelta</label><br>
            ...
            <!-- <div>
                <p>Reserva ahoraa</p>
                <input type="submit" action="vista/formReservas.php" value="Ir a reservas" name="botonReservar" >
            </div> -->
        </div>
    </div>
...
<section class="login">
    <div class="popup">
        ...
        <br>  
        Rol: <input type="text" name="role" placeholder="Ingrese su rol"><br>
        <br>  
    ...
    <div class="imagenes">
      <div class="listaimg">
        <div class="carousel-1" id="carousel-1">
            <img src="css/Imagen/Buenos Aires.png" alt="">
        </div>
        <div class="carousel-2" id="carousel-2">       
            <img src="css/Imagen/Córdoba.png" alt="">
        </div>
        <div class="carousel-3" id="carousel-3">
            <img src="css/Imagen/Mar del plata.png" alt="">
      </div>
    </div> 
 </section> 
 <section>

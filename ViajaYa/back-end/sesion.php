        ...
        <!DOCTYPE html>
            ...
            <header>
                    ...
                    <nav class="usuarios">
                        ...
                        <i class="nav-icon fa fa-sign-out" href="controlador/rutas.php" id="logoutico"></i>
                        <a href="rutas.php" class="logout">
                        <p>Cerrar Sesión</p>
                        </a>      
                    </nav>
            </header>
            ...
            ';*/
            print('   <img ="logo" src="tren-ros-retiro.jpg" alt="">');
